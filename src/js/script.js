...
function scrollFunction() {
    if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
        ...
        document.getElementById('logo').classList.add('logo__section');
        document.getElementById('btnScroll').classList.add('btnScrolls');
    } else {
        document.getElementById('header').classList.remove('section');
        document.getElementById('logo').classList.remove('logo__section');
        document.getElementById('btnScroll').classList.remove('btnScrolls');
    }
}
...
// ======================= Menu Responsive===================
var btn = document.querySelector(".header__top-btn");
var list = document.querySelector(".header__top-list");
var listItem = document.querySelectorAll(".list__item-link");
let menuStatus = true
...
// ========================== Modal ===========================
// var modalBtns = Array.from(document.querySelectorAll(".section__top-item"));
...
//         })
// })
// var closeBtns = Array.from(document.querySelectorAll(".modal__dialog-close"));
...
let scrollSmooth = {
    ...
    scrollSection: function() {
        var navLink = document.querySelectorAll(".list__item-link");
        ...
        navLink.forEach((links, index) => {
            links.addEventListener("click", (e) => {
                ...
                window.scrollTo(0, sectionPosition - 72)
            })
        })
    }
}
